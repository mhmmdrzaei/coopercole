    ...
    <section class="exhibitionMain" id="pageTop">
      ...
      <section class="exhibitionSide" id="exhibtionSideScroll">
        ...
        if($connected_artists->have_posts()): while($connected_artists->have_posts()) : $connected_artists->the_post(); ?>
          ...
          <li>
              <h1><a class="arrow" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h1>
          </li>
      ...
      <!-- end of section </section> -->
        ...
        <section class="exhibitionCenter">
            ...
            <section class="featuredVideo">
                <button class="featuredVideoTitle"><img
                        src="<?php bloginfo('template_directory'); ?>/images/movie_icon.svg">
                    <?php the_sub_field('video_label_additionalMedia') ?></button>
            ...
            ?>
                ...
                <img class="exhibitionImgsLL" src="<?php echo $slide['url']; ?>" alt=""
